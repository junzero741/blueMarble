...
let uninhabitedIsland = new SpecialLand("uninhabitedIsland", 0, "delay3turn", 5);           // [5]
let istanbul = new City("istanbul", "none", "none", 0, 6);                                  // [6]
...
let paris = new City("paris", "none", "none", 0, 14);                                       // [14]
let spaceStation = new SpecialLand("spaceStation", 0, "goAnywhere", 0, 15);                 // [15]
